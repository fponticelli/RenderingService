...
//	public var title(getTitle, setTitle) : String;
	...
	public function new(?data : Map<String, Dynamic>, ?version : HtmlVersion, language = "en", charset = "UTF-8")
	{
		super(data);
	...
	override function writeResponse(context : ControllerContext, content : String, data : Map<String, Dynamic>)
	{
	...
	function handleDom(dom : Xml, context : ControllerContext, data : Map<String, Dynamic>)
	{
	...
	function getScripts(data : Map<String, Dynamic>) : Array<Script>
	{
	...
	function getStyleSheets(data : Map<String, Dynamic>) : Array<StyleSheet>
	{
	...
	function getTitle(data : Map<String, Dynamic>)
	{
		if(null != title)
			return title;
		else
	...
	function getLanguage(data : Map<String, Dynamic>)
	{
		if(null != language)
			return language;
	...
	function getCharset(data : Map<String, Dynamic>)
	{
		if(null != charset)
			return charset;
		else
