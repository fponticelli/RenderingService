...
class ControllerActionInvoker implements IActionInvoker
{
	...
	function getParameters(controllerContext : ControllerContext, argsinfo : Array<{t: CType, opt: Bool, name: String}>, typeParameters : Map<String, CType>) : HashList<Dynamic>
	{
	...
	function getAttributes(controller : ControllerBase, actionField : String) : Array<FilterAttribute>
	{
		...
		var hash = Lambda.fold(metadata, function(meta : Dynamic, output : Map<String, Dynamic>) {
