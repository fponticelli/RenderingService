...
class ViewContext
{
	...
	public var viewData(default, null) : Map<String, Dynamic>;
	...
	public function new(controllerContext:ControllerContext, view:IView, viewEngine : IViewEngine, viewData:Map<String, Dynamic>, viewHelpers : Array<IViewHelper>)
	{
