...
{                                        
	...
	public function build(params : Map<String, String>)
	{                          
	...
	function buildSegment(segment : UriSegment, params : Map<String, String>) 
	{       
		var result = "";
	...
	static inline function getEncoded(p : Map<String, String>, k : String)
	{
	...
	static function getRestEncoded(p : Map<String, String>, k : String)
	{         
