...
class Route extends RouteBase
{
	...
	public var defaults(default, null) : Map<String, String>;
	 ...
	 * @param	?constraints
	 */
	public function new(url : String, handler : IRouteHandler, ?defaults : Map<String, String>, ?constraints : Array<IRouteConstraint>)
	{
	...
	//added public to match visibility of ROuteBase, the compiler complains on that!
	public override function getPath(httpContext : HttpContext, data : Map<String, String>)
	{
	    var params = null == data ? new Map() : data;
	...
	function processConstraints(httpContext : HttpContext, params : Map<String, String>, direction : UrlDirection)
	{
