...
class ufront_acl_Registry {
	public function __construct() {
		...
		$this->_roles = new haxe_ds_StringMap();
	}}
	...
	public function add($role, $parent = null, $parents = null) {
		if($this->exists($role)) {
...
function ufront_acl_Registry_0(&$__hx__this, &$parent, &$parents, &$role) {
	{
		$parents1 = $parents;
		if(null === $parents1) {
