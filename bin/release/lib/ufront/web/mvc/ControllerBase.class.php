...
class ufront_web_mvc_ControllerBase implements ufront_web_mvc_IController{
	...
	static $__rtti = "<class path=\"ufront.web.mvc.ControllerBase\" params=\"\">\x0A\x09<implements path=\"ufront.web.mvc.IController\"/>\x0A\x09<controllerContext public=\"1\"><c path=\"ufront.web.mvc.ControllerContext\"/></controllerContext>\x0A\x09<_valueProvider><c path=\"ufront.web.mvc.IValueProvider\"/></_valueProvider>\x0A\x09<valueProvider public=\"1\" get=\"accessor\" set=\"accessor\"><c path=\"ufront.web.mvc.IValueProvider\"/></valueProvider>\x0A\x09<get_valueProvider set=\"method\" line=\"24\"><f a=\"\"><c path=\"ufront.web.mvc.IValueProvider\"/></f></get_valueProvider>\x0A\x09<set_valueProvider set=\"method\" line=\"31\"><f a=\"valueProvider\">\x0A\x09<c path=\"ufront.web.mvc.IValueProvider\"/>\x0A\x09<c path=\"ufront.web.mvc.IValueProvider\"/>\x0A</f></set_valueProvider>\x0A\x09<executeCore set=\"method\" line=\"39\"><f a=\"async\">\x0A\x09<c path=\"hxevents.Async\"/>\x0A\x09<x path=\"Void\"/>\x0A</f></executeCore>\x0A\x09<execute public=\"1\" set=\"method\" line=\"41\"><f a=\"requestContext:async\">\x0A\x09<c path=\"ufront.web.routing.RequestContext\"/>\x0A\x09<c path=\"hxevents.Async\"/>\x0A\x09<x path=\"Void\"/>\x0A</f></execute>\x0A\x09<getViewHelpers public=\"1\" set=\"method\" line=\"50\"><f a=\"\"><c path=\"Array\"><c path=\"ufront.web.mvc.IViewHelper\"/></c></f></getViewHelpers>\x0A\x09<new public=\"1\" set=\"method\" line=\"37\"><f a=\"\"><x path=\"Void\"/></f></new>\x0A\x09<meta><m n=\":rtti\"/></meta>\x0A</class>";
