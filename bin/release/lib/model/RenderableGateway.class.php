...
class model_RenderableGateway {
	...
	public function removeOldAndUnused($age = null) {
		if(null === $age) {
	...
	public function insert($r) {
		$ob = _hx_anonymous(array("uid" => $r->get_uid(), "config" => model_RenderableGateway::serialize($r->config), "createdOn" => $r->createdOn->getTime(), "html" => $r->html, "lastUsage" => $r->lastUsage->getTime(), "usages" => $r->usages, "expiresOn" => model_RenderableGateway_0($this, $r)));
...
function model_RenderableGateway_0(&$__hx__this, &$r) {
