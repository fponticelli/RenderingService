...
class App {
	...
	static function main() {
		...
		$config = new ufront_web_AppConfiguration("controller", true, App::$BASE_PATH, null, true); $routes = new ufront_web_routing_RouteCollection(null); $app = new ufront_web_mvc_MvcApplication($config, $routes, null);
