...
class haxe_rtti_CType extends Enum {
	public static function CAbstract($name, $params) { return new haxe_rtti_CType("CAbstract", 7, array($name, $params)); }
	...
	public static $__constructors = array(7 => 'CAbstract', 5 => 'CAnonymous', 2 => 'CClass', 6 => 'CDynamic', 1 => 'CEnum', 4 => 'CFunction', 3 => 'CTypedef', 0 => 'CUnknown');
	}
