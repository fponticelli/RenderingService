...
class haxe_rtti_TypeTree extends Enum {
	public static function TAbstractdecl($a) { return new haxe_rtti_TypeTree("TAbstractdecl", 4, array($a)); }
	...
	public static $__constructors = array(4 => 'TAbstractdecl', 1 => 'TClassdecl', 2 => 'TEnumdecl', 0 => 'TPackage', 3 => 'TTypedecl');
	}
