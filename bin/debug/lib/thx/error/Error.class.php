...
class thx_error_Error extends thx_util_Message {
	...
	public function toStringError($pattern = null) {
		$prefix = thx_core_Strings::format(thx_error_Error_0($this, $pattern), new _hx_array(array($this->pos->className, $this->pos->methodName, $this->pos->lineNumber, $this->pos->fileName, $this->pos->customParams)), null, null);
